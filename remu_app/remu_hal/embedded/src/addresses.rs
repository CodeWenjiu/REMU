...
/// Mouse device base address (default: mouse@0x8800_1000).
pub(crate) const MOUSE_BASE: usize = 0x8800_1000;

/// Keyboard device base address (default: keyboard@0x8800_2000).
pub(crate) const KEYBOARD_BASE: usize = 0x8800_2000;
