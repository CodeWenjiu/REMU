...
pub use host::{
    ...
    put_pixel, read_disp_h, read_disp_size, read_disp_w, read_key, read_key_code, read_key_down,
    read_key_text, read_key_valid, read_mouse, read_mouse_buttons, read_mouse_x, read_mouse_y,
};
