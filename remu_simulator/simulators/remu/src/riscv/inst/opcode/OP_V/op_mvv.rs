...
#[inline(always)]
pub(super) fn nf_from_vlmul(vlmul: u32) -> usize {
    match vlmul & 0x7 {
        0 => 1,
        1 => 2,
        2 => 4,
...
#[inline(always)]
pub(super) fn vector_element_loop<P, C, F>(
    ctx: &mut C,
    rd: usize,
    rs2: Option<usize>,
    mut op: F,
...
#[inline(always)]
pub(super) fn vector_element_loop_masked<P, C, F>(
    ctx: &mut C,
    rd: usize,
    rs2: Option<usize>,
    mut op: F,
...
#[inline(always)]
pub(super) fn vector_mask_cmp_vi<P, C>(
    ctx: &mut C,
    vd: usize,
    vs2: usize,
    simm5: u32,
